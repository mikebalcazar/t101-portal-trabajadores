...
|---|---|---|
| 2026-09-19 | 0.13.1 | **El panel entra como las demás pantallas de la suite.** Mike revisó el 19-sep que todas las apps entren con correo y contraseña o con Google, con recuperación por código al correo; el panel de roster101 era el único que se había quedado en la pantalla de antes del 16-sep (correo → código, «Entrar con mi PIN», Google). Ahora: correo → contraseña; «Olvidé mi contraseña» manda un código al correo y con él se pone una nueva (es la misma puerta para quien entra por primera vez: sin contraseña puesta, el panel no se abre hasta ponerla; con Google no se pide); el PIN se fue de esta pantalla. La contraseña equivocada y el correo sin cuenta dicen lo mismo, a propósito. Medido con navegador en `pruebas/0113-entrada-del-panel.mjs` (25 comprobaciones). El portal del trabajador no cambia. |
